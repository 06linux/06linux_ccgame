...
import { BaseSav, BaseSav_Data } from "../../base/BaseSav";
...
cc.Class({
    ...
    OnClick(touch) {
        ...
        if (touch.target.name == 'btn_test1') {
            ...
            console.log('usersav uuid', BaseSav.Instance().GetUUID());
        }

        if (touch.target.name == 'btn_test2') {

            BaseSav.Instance().ReadData();
            console.log('ReadData', BaseSav_Data);
        }

        if (touch.target.name == 'btn_test3') {

            BaseSav_Data.name = 'user002xxxx';
            BaseSav.Instance().WriteData();
        }
    },
