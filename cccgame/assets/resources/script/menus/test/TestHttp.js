...
cc.Class({
     ...
     */
    OnClick(touch) {
        console.log("TestHttp OnClick:", touch.target.name, touch );
        ...
        if (touch.target.name == 'btn_test') {
            ...
            http.AddParam("appid", "ldqq");
            http.AddParam("channel", "test");
            http.AddParam("uid", "zhangsan");
            let url = "http://cathome8.com/zjserver/zjrank/zjrank/protocol/10004.php";
